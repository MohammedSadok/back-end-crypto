...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/accounts/**").fullyAuthenticated();
        http.authorizeRequests().antMatchers("/portfolio/**").fullyAuthenticated();
        http.authorizeRequests().antMatchers( "/transaction/**").fullyAuthenticated();
